...
fun PickupScreen(
    ...
    Card(
        ...
        Column(Modifier.padding(16.dp)) {
                    ...
                    confirmButton = {
                        TextButton(onClick = {
                            datePickerState.selectedDateMillis?.let {
                                onEvent(FormEvent.UpdatePickupDate(dateFormat.format(Date(it))))
                            }
            ...
            OutlinedTextField(
                value = state.run,
                onValueChange = { if (it.all(Char::isDigit)) onEvent(FormEvent.UpdatePickupRun(it)) },
                label = { Text("Run #") },
                modifier = Modifier.fillMaxWidth(),
                colors = customTextFieldColors,
            ...
            OutlinedTextField(
                ...
                onValueChange = { onEvent(FormEvent.UpdatePickupDriverName(it)) },
            ...
            OutlinedTextField(
                ...
                onValueChange = { onEvent(FormEvent.UpdatePickupDriverNumber(it)) },
            ...
            OutlinedTextField(
                ...
                onValueChange = { onEvent(FormEvent.UpdatePickupFacilityName(it)) },
            ...
            Row(
                ...
                OutlinedTextField(
                    ...
                    onValueChange = { if (it.all(Char::isDigit)) onEvent(FormEvent.UpdatePickupFrozenBags(it)) },
                    label = { Text("Bags") },
                ...
                OutlinedTextField(
                    ...
                    onValueChange = { if (it.all(Char::isDigit)) onEvent(FormEvent.UpdatePickupFrozenQuantity(it)) },
                    label = { Text("Quantity") },
                    modifier = Modifier.weight(1f),
                    colors = customTextFieldColors,
                    keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number),
            ...
            Row(
                ...
                OutlinedTextField(
                    ...
                    onValueChange = { if (it.all(Char::isDigit)) onEvent(FormEvent.UpdatePickupRefrigeratedBags(it)) },
                    label = { Text("Bags") },
                    modifier = Modifier.weight(1f),
                    colors = customTextFieldColors,
                    keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number),
                ...
                OutlinedTextField(
                    ...
                    onValueChange = { if (it.all(Char::isDigit)) onEvent(FormEvent.UpdatePickupRefrigeratedQuantity(it)) },
                    label = { Text("Quantity") },
                    modifier = Modifier.weight(1f),
                    colors = customTextFieldColors,
                    keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number),
            ...
            Row(
                ...
                OutlinedTextField(
                    ...
                    onValueChange = { if (it.all(Char::isDigit)) onEvent(FormEvent.UpdatePickupRoomTempBags(it)) },
                    label = { Text("Bags") },
                    modifier = Modifier.weight(1f),
                    colors = customTextFieldColors,
                    keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number),
                ...
                OutlinedTextField(
                    ...
                    onValueChange = { if (it.all(Char::isDigit)) onEvent(FormEvent.UpdatePickupRoomTempQuantity(it)) },
                    label = { Text("Quantity") },
                    modifier = Modifier.weight(1f),
                    colors = customTextFieldColors,
                    keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number),
            ...
            Row(
                ...
                OutlinedTextField(
                    ...
                    onValueChange = { if (it.all(Char::isDigit)) onEvent(FormEvent.UpdatePickupOthersBags(it)) },
                    label = { Text("Bags") },
                    modifier = Modifier.weight(1f),
                    colors = customTextFieldColors,
                    keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number),
                ...
                OutlinedTextField(
                    ...
                    onValueChange = { if (it.all(Char::isDigit)) onEvent(FormEvent.UpdatePickupOthersQuantity(it)) },
                    label = { Text("Quantity") },
                    modifier = Modifier.weight(1f),
                    colors = customTextFieldColors,
                    keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number),
            ...
            Row(
                ...
                OutlinedTextField(
                    ...
                    onValueChange = { if (it.all(Char::isDigit)) onEvent(FormEvent.UpdatePickupBoxesQuantity(it)) },
                    label = { Text("Quantity") },
                    modifier = Modifier.weight(1f),
                    colors = customTextFieldColors,
                    keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number),
            ...
            Row(
                ...
                OutlinedTextField(
                    ...
                    onValueChange = { if (it.all(Char::isDigit)) onEvent(FormEvent.UpdatePickupColoredBagsQuantity(it)) },
                    label = { Text("Quantity") },
                    modifier = Modifier.weight(1f),
                    colors = customTextFieldColors,
                    keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number),
            ...
            Row(
                ...
                OutlinedTextField(
                    ...
                    onValueChange = { if (it.all(Char::isDigit)) onEvent(FormEvent.UpdatePickupMailsQuantity(it)) },
                    label = { Text("Quantity") },
                    modifier = Modifier.weight(1f),
                    colors = customTextFieldColors,
                    keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number),
            ...
            Row(
                ...
                OutlinedTextField(
                    ...
                    onValueChange = { if (it.all(Char::isDigit)) onEvent(FormEvent.UpdatePickupMoneyBagsQuantity(it)) },
                    label = { Text("Quantity") },
                    modifier = Modifier.weight(1f),
                    colors = customTextFieldColors,
                    keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number),
            ...
            OutlinedTextField(
                value = state.notes,
                onValueChange = { onEvent(FormEvent.UpdatePickupNotes(it)) },
                label = { Text("Notes") },
                modifier = Modifier.fillMaxWidth(),
                colors = customTextFieldColors,
            )
            ...
            MultiImagePicker(
                images = state.images,
                onImageAdded = { uri -> onEvent(FormEvent.AddPickupImage(uri)) },
                onImageRemoved = { uri -> onEvent(FormEvent.RemovePickupImage(uri)) }
            )
            Spacer(Modifier.height(16.dp))
            ...
            OutlinedTextField(
                ...
                onValueChange = { onEvent(FormEvent.UpdatePickupPrintSignature(it)) },
            ...
            SignatureBox(
                ...
                onBitmapChange = { bmp -> onEvent(FormEvent.UpdatePickupSignature(bmp)) },
            )
        }
    }
}