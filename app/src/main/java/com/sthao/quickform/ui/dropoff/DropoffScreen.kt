...
fun DropoffScreen(
    ...
    Card(
        ...
        Column(Modifier.padding(16.dp)) {
                    ...
                    confirmButton = {
                        TextButton(onClick = {
                            datePickerState.selectedDateMillis?.let {
                                onEvent(FormEvent.UpdateDropoffDate(dateFormat.format(Date(it))))
                            }
            ...
            OutlinedTextField(
                value = state.run,
                onValueChange = { if (it.all(Char::isDigit)) onEvent(FormEvent.UpdateDropoffRun(it)) },
                label = { Text("Run #") },
                modifier = Modifier.fillMaxWidth(),
                colors = customTextFieldColors,
            ...
            OutlinedTextField(
                ...
                onValueChange = { onEvent(FormEvent.UpdateDropoffDriverName(it)) },
            ...
            OutlinedTextField(
                ...
                onValueChange = { onEvent(FormEvent.UpdateDropoffDriverNumber(it)) },
            ...
            OutlinedTextField(
                ...
                onValueChange = { onEvent(FormEvent.UpdateDropoffFacilityName(it)) },
            ...
            Row(
                ...
                OutlinedTextField(
                    ...
                    onValueChange = { if (it.all(Char::isDigit)) onEvent(FormEvent.UpdateDropoffFrozenBags(it)) },
                    label = { Text("Bags") },
                ...
                OutlinedTextField(
                    ...
                    onValueChange = { if (it.all(Char::isDigit)) onEvent(FormEvent.UpdateDropoffFrozenQuantity(it)) },
                    label = { Text("Quantity") },
                    modifier = Modifier.weight(1f),
                    colors = customTextFieldColors,
                    keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number),
            ...
            Row(
                ...
                OutlinedTextField(
                    ...
                    onValueChange = { if (it.all(Char::isDigit)) onEvent(FormEvent.UpdateDropoffRefrigeratedBags(it)) },
                    label = { Text("Bags") },
                    modifier = Modifier.weight(1f),
                    colors = customTextFieldColors,
                    keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number),
                ...
                OutlinedTextField(
                    ...
                    onValueChange = { if (it.all(Char::isDigit)) onEvent(FormEvent.UpdateDropoffRefrigeratedQuantity(it)) },
                    label = { Text("Quantity") },
                    modifier = Modifier.weight(1f),
                    colors = customTextFieldColors,
                    keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number),
            ...
            Row(
                ...
                OutlinedTextField(
                    ...
                    onValueChange = { if (it.all(Char::isDigit)) onEvent(FormEvent.UpdateDropoffRoomTempBags(it)) },
                    label = { Text("Bags") },
                    modifier = Modifier.weight(1f),
                    colors = customTextFieldColors,
                    keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number),
                ...
                OutlinedTextField(
                    ...
                    onValueChange = { if (it.all(Char::isDigit)) onEvent(FormEvent.UpdateDropoffRoomTempQuantity(it)) },
                    label = { Text("Quantity") },
                    modifier = Modifier.weight(1f),
                    colors = customTextFieldColors,
                    keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number),
            ...
            Row(
                ...
                OutlinedTextField(
                    value = state.othersBags,
                    onValueChange = { if (it.all(Char::isDigit)) onEvent(FormEvent.UpdateDropoffOthersBags(it)) },
                    label = { Text("Bags") },
                    modifier = Modifier.weight(1f),
                    colors = customTextFieldColors,
                    keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number),
                ...
                OutlinedTextField(
                    ...
                    onValueChange = { if (it.all(Char::isDigit)) onEvent(FormEvent.UpdateDropoffOthersQuantity(it)) },
                    label = { Text("Quantity") },
                    modifier = Modifier.weight(1f),
                    colors = customTextFieldColors,
                    keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number),
            ...
            Row(
                ...
                OutlinedTextField(
                    ...
                    onValueChange = { if (it.all(Char::isDigit)) onEvent(FormEvent.UpdateDropoffBoxesQuantity(it)) },
                    label = { Text("Quantity") },
                    modifier = Modifier.weight(1f),
                    colors = customTextFieldColors,
                    keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number),
            ...
            Row(
                ...
                OutlinedTextField(
                    ...
                    onValueChange = { if (it.all(Char::isDigit)) onEvent(FormEvent.UpdateDropoffColoredBagsQuantity(it)) },
                    label = { Text("Quantity") },
                    modifier = Modifier.weight(1f),
                    colors = customTextFieldColors,
                    keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number),
            ...
            Row(
                ...
                OutlinedTextField(
                    ...
                    onValueChange = { if (it.all(Char::isDigit)) onEvent(FormEvent.UpdateDropoffMailsQuantity(it)) },
                    label = { Text("Quantity") },
                    modifier = Modifier.weight(1f),
                    colors = customTextFieldColors,
                    keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number),
            ...
            Row(
                ...
                OutlinedTextField(
                    ...
                    onValueChange = { if (it.all(Char::isDigit)) onEvent(FormEvent.UpdateDropoffMoneyBagsQuantity(it)) },
                    label = { Text("Quantity") },
                    modifier = Modifier.weight(1f),
                    colors = customTextFieldColors,
                    keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number),
            ...
            OutlinedTextField(
                value = state.notes,
                onValueChange = { onEvent(FormEvent.UpdateDropoffNotes(it)) },
                label = { Text("Notes") },
                modifier = Modifier.fillMaxWidth(),
                colors = customTextFieldColors,
            )
            ...
            MultiImagePicker(
                images = state.images,
                onImageAdded = { uri -> onEvent(FormEvent.AddDropoffImage(uri)) },
                onImageRemoved = { uri -> onEvent(FormEvent.RemoveDropoffImage(uri)) }
            )
            Spacer(Modifier.height(16.dp))

            // The text field for the printed name.
            OutlinedTextField(
                value = state.printSignature,
                onValueChange = { onEvent(FormEvent.UpdateDropoffPrintSignature(it)) },
            ...
            // The shared component for capturing a signature.
            SignatureBox(
                bitmap = state.signature,
                onBitmapChange = { bmp -> onEvent(FormEvent.UpdateDropoffSignature(bmp)) },
            )
        }
    }
}