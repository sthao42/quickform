...
-   **Saved Entries Management**:
    ...
    -   A powerful multi-select mode allows for performing bulk operations on saved entries.
...
-   **PDF Exporting and Sharing**:
    ...
    -   PDFs feature a consistent layout, with attached images neatly organized into a two-column grid.
